...
import com.java.arquillian.MyApplication;
import com.java.arquillian.resource.Database;
import com.java.arquillian.resource.MyResource;
...
public class MyResourceIT {
	...
	public static WebArchive createDeployment() {
		WebArchive war = ShrinkWrap.create(WebArchive.class).addClass(MyApplication.class).addClass(Database.class)
